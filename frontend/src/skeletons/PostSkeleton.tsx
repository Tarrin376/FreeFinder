    ...
    return (
        <div className="bg-main-white w-[290px] rounded-[8px] border border-light-gray shadow-post overflow-hidden">
            ...
            <div className="p-4">
                ...
                <div className="w-[120px] h-[15px] loading mt-3"></div>
                <div className="w-[100%] h-[17px] loading mb-2 mt-5"></div>
                <div className="w-[80%] h-[17px] loading mb-5"></div>
                <div className="mt-4 flex items-center justify-between border-t border-t-light-gray pt-4">
                    <div className="w-[55%] h-[22px] loading"></div>
