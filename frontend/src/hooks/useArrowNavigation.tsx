...
export function useArrowNavigation<T>(componentRef: React.RefObject<HTMLDivElement>, inputRef: React.RefObject<HTMLInputElement>, 
    data: T[], heightOffset: number, componentHeight: number): number {
