...
import MatchedResults from "../common/MatchedResults";
import Options from "../common/Options";

interface TypeOfWorkFilterProps {
    selectedWork: string[],
    updateSelectedWork: (selectedWork: string[]) => void
}

function TypeOfWorkFilter({ selectedWork, updateSelectedWork }: TypeOfWorkFilterProps) {
