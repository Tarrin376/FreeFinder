...
import DeliveryTimes from "../common/DeliveryTimes";
import SearchLanguages from "../common/SearchLanguages";
import SellerLevels from "../Seller/SellerLevels";
import TypeOfWorkFilter from "./TypeOfWorkFilter";
...
function AllFilters({ loading, dispatch, state }: AllFiltersProps) {
