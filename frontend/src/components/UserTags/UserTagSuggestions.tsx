...
import { TAG_SUGGESTIONS_HEIGHT } from "../../views/LiveChat/SelectedGroupChat/ChatBox";

interface UserTagSuggestionsProps {
    tag: string,
...
function UserTagSuggestions({ tag, groupMembers, inputRef, dispatch, matchedMembers, selectedTagIndex, suggestionsRef }: UserTagSuggestionsProps) {
...
export default UserTagSuggestions;