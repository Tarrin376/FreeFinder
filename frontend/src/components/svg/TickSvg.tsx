...
function TickSvg({ size, colour, styles }: TickSvgProps) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0,0,256,256" fillRule="nonzero" 
        className={styles} style={{ width: `${size}px`, height: `${size}px` }}>
