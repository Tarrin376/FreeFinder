...
import StarSvg from '../Review/StarSvg';
...
function PostCard({ postInfo, index, canRemove, count, styles }: PostProps) {
    ...
    return (
        ...
        exit={{ opacity: 0 }} transition={{ delay: 0.05 * (index % limit), duration: 0.2 }}>
            {userContext.userData.username !== postInfo.postedBy.user.username && userContext.userData.username !== "" &&
            <Save
